...
#ifndef MOSKITOWATERCONST_H
#define MOSKITOWATERCONST_H

#include "SinglePhaseFluidProperties.h"



class MoskitoWaterConst : public SinglePhaseFluidProperties
{
public:
  static InputParameters validParams();
  MoskitoWaterConst(const InputParameters & parameters);
  virtual ~MoskitoWaterConst();
